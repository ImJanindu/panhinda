...
Revision ID: 2d4d8c960cc0
Revises: 
Create Date: 2025-05-26 00:42:40.466698
...
def upgrade():
    ...
    with op.batch_alter_table('article_like', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_article_like_added'), ['added'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('article_like', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_article_like_added'))
