...
class ForbiddenError(BaseError):
    def __init__(self, message: str='Sorry! Cannot Allow to Proceed', previous_url: str='index'):
        super().__init__(status_code=403, message=message, previous_url=previous_url)
        

class MethodNotAllowedError(BaseError):
    def __init__(self, message: str='Sorry! Request Method is not Allowed', previous_url: str='index'):
